...
class MyAccount extends Component {
    ...
    // 列表
    async getList () {
        const {pagination, searchParams, defaultTrackerId} = this.state;
        ...
        params.trackId = defaultTrackerId;
    ...
    async getAllAmountTotal () {
        ...
        const {searchParams, defaultTrackerId} = this.state;
        searchParams.trackId = defaultTrackerId;
    ...
    render () {
        ...
        const {
            ...
            myCase,                                         // 跳转到案件权限
            myAccountSeparateModalCode                      // 分单权限
        ...
        return (
            <div>
                ...
                <div className="m-b-xs">
                    {myAccountSeparateModalCode && <Button className="m-r-xs m-t-xs" type="primary" onClick={this.openSeparateModal}>分单</Button>}
