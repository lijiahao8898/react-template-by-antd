                    ...
                    <Form layout="inline">
                            ...
                            {getFieldDecorator('relationship', {
                                ...
                                <Select
                                    ...
                                    {relationShip.map(item => {
                                        return (
                                            <Option key={item.code} title={item.name} value={item.code}>
                                                {item.name}
                                            </Option>
                                        );
                                    })}
                        ...
                        <FormItem label="手机" {...labelConfig}>
                            {getFieldDecorator(`${type === 2 ? 'contactMobile' : 'contactPersonMobile'}`, {
                                ...
                                <Input type="text" placeholder="请输入手机" style={{width: width}} onChange={this.changeUserMobile.bind(this)}/>
                            )}
                        </FormItem>
